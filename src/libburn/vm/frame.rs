...
pub struct Frame {
	...
	pub shared_local_variables: Vec<value::SharedValue>,
	...
	impl Frame {
		...
		pub fn new_script( script: Box<Script>, local_variables: Vec<value::Value>, shared_local_variables: Vec<value::SharedValue> ) -> Frame {
			Frame {
		...
		pub fn new_function( function: Gc<Function>, local_variables: Vec<value::Value>, shared_local_variables: Vec<value::SharedValue> ) -> Frame {
			Frame {
